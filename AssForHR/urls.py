...
urlpatterns = [
    ...
    url(r'^spacegame/starmanage/(?P<starid>\d+)/(?P<areaid>\d+)/(?P<panelid>\d+)/main_building_edit/$'
        , spacegameindex.area_main_building_edit),
    url(r'^spacegame/starmanage/(?P<starid>\d+)/(?P<areaid>\d+)/(?P<panelid>\d+)/add_building_edit/$'
        , spacegameindex.area_add_building_edit),
    url(r'^spacegame/starmanage/(?P<starid>\d+)/(?P<areaid>\d+)/(?P<panelid>\d+)/main_building_build/$'
        , spacegameindex.area_main_building_build),
